(() => {
  ...
  /* ==========================================================
     ...
     Controla idioma, apariencia, enlaces a cada perfil y retorno arriba.
     La documentación interna del código se mantiene en español.
     ========================================================== */

  /* Textos bilingües del selector de perfiles profesionales. */
  const t = {
    es: {
      home: 'Volver al sitio personal',
      kicker: 'CURRÍCULUM VITAE · PERFILES PROFESIONALES',
      title1: 'Tres formas de contar',
      title2: 'la misma trayectoria.',
      ...
      eTitle: 'Eléctrica y Automatización',
      eCopy: 'Experiencia, formación y competencias orientadas a instalaciones eléctricas, mantenimiento, baja tensión, automatización y documentación técnica.',
      nTitle: 'Redes Informáticas',
      nCopy: 'Versión web completa con networking, infraestructura, routing, switching, servicios, Linux, virtualización, contenedores, SDN, observabilidad y automatización.',
      gTitle: 'Perfil General',
      gCopy: 'Perfil multidisciplinario completo para posiciones donde conviene presentar juntas la experiencia eléctrica, tecnológica, de soporte e infraestructura.',
      available: 'Disponible',
      building: 'En construcción',
      noteCode: 'CÓMO USARLO',
      ...
      footer: 'Rubén Enrique Cañizares Miranda · Currículum Vitae',
      back: 'Inicio',
      top: 'Volver arriba'
    },
    en: {
      home: 'Back to personal site',
      kicker: 'CURRICULUM VITAE · PROFESSIONAL PROFILES',
      title1: 'Three ways to present',
      title2: 'the same career path.',
      ...
      eTitle: 'Electrical & Automation',
      eCopy: 'Experience, education and skills focused on electrical installations, maintenance, low voltage, automation and technical documentation.',
      nTitle: 'Computer Networks',
      nCopy: 'Complete web profile covering networking, infrastructure, routing, switching, services, Linux, virtualization, containers, SDN, observability and automation.',
      gTitle: 'General Profile',
      gCopy: 'Complete multidisciplinary profile for roles where electrical, technology, support and infrastructure experience should be presented together.',
      available: 'Available',
      building: 'In progress',
      noteCode: 'HOW TO USE IT',
      ...
      footer: 'Rubén Enrique Cañizares Miranda · Curriculum Vitae',
      back: 'Home',
      top: 'Back to top'
    }
  };
  ...
  /* Ajusta el tema claro para evitar blancos puros y mantener contraste suave. */
  ...
  /* Fuerza el regreso a la posición superior del documento. */
  ...
  /* Botón flotante para páginas largas del centro de CV. */
  ...
  /* Aplica idioma y actualiza los enlaces de cada perfil profesional. */
  function setLang(next) {
    ...
    if (topButton) topButton.setAttribute('aria-label', t[lang].top);
  ...
  /* Aplica y conserva el tema seleccionado. */
